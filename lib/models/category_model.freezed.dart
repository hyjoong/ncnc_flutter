...
abstract class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, double discountRate, String imageUrl});
}
...
class _$CategoryImpl implements _Category {
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, discountRate: $discountRate, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, discountRate, imageUrl);
